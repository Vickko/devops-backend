...
require (
	...
	github.com/cloudwego/eino-ext/devops v0.0.0
...
replace github.com/cloudwego/eino-ext/devops => github.com/Vickko/eino-devops-custom v0.0.0-20251209124408-03d5490ff5d4
