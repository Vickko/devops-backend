...
func newOpenRouterRaw(ctx context.Context, cfg conf.Client, modelName string, opts ...model.Option) (model.BaseChatModel, error) {
...
func newOpenRouter(ctx context.Context, cfg conf.Client, modelName string, opts ...model.Option) (model.BaseChatModel, error) {
...
type openRouterAdapter struct{ raw model.BaseChatModel }
